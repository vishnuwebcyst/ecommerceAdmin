    ...
    <div class="main-wrapper">
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="row" method="post" action="{{ route('category.update',$category->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Category Name</label>
                                    <input type="text" oninput="createSlug(this.value)" name="name" value="{{ $category->name }}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="image-upload {{ $category->image != "" ?'pb-5':''}}">
                                        <input type="file" name="image" onchange="updateImage()" id="file-input">
                                        @if($category->image != "")
                                        <div class="image-uploads">
                                            <a href="{{route('cat_file.delete',$category->id)}}" class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-danger pt-2" style="height: 30px;width:30px;font-size:15px;">
                                                X</a>
                                            <img src="{{ asset($category->image) }}" alt="img" width="100">
                                        </div>
                                        @else
                                        <div class="image-uploads">
