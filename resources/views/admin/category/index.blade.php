                ...
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="{{ route('category.create') }}" class="btn btn-added">
                            <img src="{{ asset('admin/images/plus.svg') }}" class="me-1" alt="img">Add Category
                        </a>
                    </div>
                </div>
                                        ...
                                        <div class="col-lg-1 col-sm-6 col-12 ms-auto">
                                            <div class="form-group">
                                                <a class="btn btn-filters ms-auto"><img
                                                        src=" admin/images/search-whites.svg" alt="img"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        @foreach ($category as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="me-3" href="{{ route('category.edit', $item->id) }}">
