...
$(document).ready(function () {
    ...
    var right_side_views =
        ...
        '<img src="admin/images/siderbar-icon2.svg" class="feather-five" alt="">' +
        ...
        "</div>" +
        '<div class="col-xl-6 col-sm-6 col-12">' +
        '<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="admin/images/sidebar-delete-icon.svg" alt="demo"></a>' +
        "</div>" +
        "</div>" +
        "</div>" +
        "</div>" +
    ...
    var customize_link =
        ...
        '<img src="admin/images/sidebar-icon-01.svg" class="feather-five" alt="">' +
        "</a>" +
        "</li>" +
        '<li class="sidebar-icons">' +
        '<a href="#" class="navigation-add" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
        '<img src="admin/images/sidebar-icon-02.svg" class="feather-five" alt="">' +
        "</a>" +
        "</li>" +
        '<li class="sidebar-icons">' +
        ...
        '<img src="admin/images/sidebar-icon-03.svg" class="feather-five" alt="">' +
        "</a>" +
        "</li>" +
        "</ul>" +
        "</div>" +
        ...
        '<a class="sidebar-close" href="#"><img src="admin/images/close-icon.svg" alt=""></a>' +
        "</div>" +
        '<div class="sidebar-body">' +
        '<h6 class="theme-title">Choose Mode</h6>' +
        '<div class="switch-wrapper">' +
        '<div id="dark-mode-toggle">' +
        '<span class="light-mode active"> <img src="admin/images/sun-icon.svg" class="me-2" alt=""> Light</span>' +
